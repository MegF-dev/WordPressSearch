    ...
    function performSearch(searchTerm) {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                var combinedCategoriesAndTags = categories.concat(
                    tags,
                    searchtags
                );
                if (combinedCategoriesAndTags.length > 0) {
                    ...
                    $.each(
                        combinedCategoriesAndTags,
                        function (index, category) {
                            if (category.display_name) {
                                resultHtml +=
                                    "<li><a href='" + category.link + "'>";
                ...
                setTimeout(function () {
                    if (response.is_brand_search) {
                        ...
                        function toSingular(word) {
                            ...
                            $(
                                ".search-list-categories li:nth-child(n+6)"
                            ).hide();
                        ...
                        function filterList(searchTerm) {
                            ...
                            $listItems.each(function () {
                                ...
                                var shouldShow = singularizedTerms.some(
                                    function (term) {
